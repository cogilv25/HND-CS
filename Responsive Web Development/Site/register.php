...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .links, .links:visited, .activelink:visited
      {
        color: #606060;
      }
      ...
      .links:active, .activelink:active
      {
        color: #C0C0C0;
      }
  	...
  	<div class="container-fluid">
	    <div class="row justify-content-center">
	        <div class="col-2 col-md-10">
	            <a href="index"><div class="container">
            ...
            <a href="index">
                <img class="img-default" src="homeActive.png"></img>
                <img class="img-hover" src="homeHover.png"></img>
            </a>
          </div>
	        <div class="col-2 d-md-none logocontainer" style="color: #FFFFFF">
	        	<a href="profile.html">
		            <img class="img-default" src="profile.png"></img>
    ...
    <div class="container-fluid">
      	<div class="row justify-content-center">
            ...
            <div class="col-2 d-none d-md-block">
              <a class="nav-link text-center fs-3 activelink" href="index.html">Home</a>
             </div>
            <div class="col-2 d-none d-md-block">
              <a class="nav-link text-center fs-3 links" href="profile.html">Profile</a>
            </div>
            <div class="col-2 d-none d-md-block">
              <a class="nav-link text-center fs-3 links" href="basket.html">Basket</a>
            </div>
