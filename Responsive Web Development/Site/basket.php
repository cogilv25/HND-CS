  ...
  <body style="background-color: #282828;">
	    ...
	    <div class="row justify-content-center">
          ...
          <div class="col-2 d-md-none logocontainer" style="color: #FFFFFF">
            <a href="https://comp-server.uhi.ac.uk/~21010093/bootstrap/basket.html">
                <img class="img-default" src="cartActive.png"></img>
    ...
    <div class="container-fluid">
      	<div class="row justify-content-center">
            ...
            <div class="col-2 d-none d-md-block">
              <a class="nav-link text-center fs-3 links" href="#">Profile</a>
            </div>
            <div class="col-2 d-none d-md-block">
              <a class="nav-link text-center fs-3 activelink" href="#">Basket</a>
            </div>
